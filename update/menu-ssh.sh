...
echo -e "$COLOR1 $NC  SSH-WS     : $portsshws, 80" 
...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/kenDevXD/multi-ws/main/ssh/proxy3.js"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" 
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/kenDevXD/multi-ws/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler
...
Login=aixxy7`</dev/urandom tr -dc X-Z0-9 | head -c4`
hari="1"
Pass=1
