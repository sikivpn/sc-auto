...
export COLOR1="$(cat /etc/aixxy7/theme/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
export COLBG1="$(cat /etc/aixxy7/theme/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')"                    
###########- END COLOR CODE -##########
...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/sikivpn/sc-auto/main/permission/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/sikivpn/sc-auto/main/permission/ipmini | grep $MYIP | awk '{print $2}')
Isadmin=$(curl -sS https://raw.githubusercontent.com/sikivpn/sc-auto/main/permission/ipmini | grep $MYIP | awk '{print $5}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/sikivpn/sc-auto/main/permission/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/sikivpn/sc-auto/main/permission/ipmini | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
echo "IP=$host" > /var/lib/aixxy7-pro/ipvps.conf
echo ""
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/sikivpn/sc-auto/main/permission/update/install_up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/sikivpn/sc-auto/main/permission/update/version_up)
...
serverV=$( curl -sS https://raw.githubusercontent.com/sikivpn/sc-auto/main/permission/update/version_up)
if [ "$Isadmin" = "ON" ]; then
