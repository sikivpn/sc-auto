...
APIGIT=$(cat /etc/aixxy7/github/api)
EMAILGIT=$(cat /etc/aixxy7/github/email)
USERGIT=$(cat /etc/aixxy7/github/username)
...
if [[ -f /etc/aixxy7/github/api && -f /etc/aixxy7/github/email && /etc/aixxy7/github/username ]]; then
   rec="OK"
else
    mkdir /etc/aixxy7/github > /dev/null 2>&1
fi
...
sleep 2
echo "$EMAIL1" > /etc/aixxy7/github/email
echo "$USERNAME1" > /etc/aixxy7/github/username
echo "$API1" > /etc/aixxy7/github/api
echo "ON" > /etc/aixxy7/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
function resetipvps(){
clear
rm -f /etc/aixxy7/github/email
rm -f /etc/aixxy7/github/username
rm -f /etc/aixxy7/github/api
rm -f /etc/aixxy7/github/gitstat
echo "OFF" > /etc/aixxy7/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1│${NC} [INFO] PM : @aixxy7 / t.me/aixxy7"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── WM ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • Premium Auto Script •            $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/aixxy7/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/aixxy7/github
    touch /etc/aixxy7/github/gitstat
    echo "OFF" > /etc/aixxy7/github/gitstat
fi

stst1=$(cat /etc/aixxy7/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
stst=$(cat /etc/aixxy7/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
